...
import { createVorkommnis } from '../../api/api.js'

const INITIAL = {
  datum: '', art_stoerung: '', folgen: '', meldung_behoerde: '',
  meldung_hersteller: '', korrektivmassnahmen: '', bemerkungen: '',
}

export default function VorkommnisDialog({ geraetId, onClose, onSaved }) {
  const ref = useRef()
  ...
  return (
    <dialog ref={ref} onCancel={onClose} style={{ width: 540 }}>
      <div className="dlg-hd">Vorkommnis / Störung erfassen (§3 MPDG / Art. 87 MDR)</div>
